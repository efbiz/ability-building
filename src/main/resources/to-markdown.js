(function (f) {
  ...
  return (function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      var blocks = ['address', 'article', 'aside', 'audio', 'blockquote',
        'body',
    ...
    2: [function (require, module, exports) {
      ...
      function cell(content, node) {
        var index = Array.prototype.indexOf.call(node.parentNode.childNodes,
            node)
        var prefix = ' '
        if (index === 0) {
          prefix = '| '
    ...
    3: [function (require, module, exports) {
      ...
      module.exports = canParseHtmlNatively() ? _window.DOMParser
          : createHtmlParser()
    ...
    4: [function (require, module, exports) {
      ...
      module.exports = [
        ...
        {
          filter: function (node) {
            return node.nodeName === 'PRE' && node.firstChild.nodeName
                === 'CODE'
          },
          replacement: function (content, node) {

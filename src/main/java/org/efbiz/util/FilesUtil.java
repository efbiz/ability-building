...
public class FilesUtil {
  ...
  public static void delAllFile(String path) {
    ...
    if (file.getAbsolutePath().equalsIgnoreCase("/usr") || file.getAbsolutePath()
        .equalsIgnoreCase("/opt")
        || file.getAbsolutePath().equalsIgnoreCase("/bin") || file.getAbsolutePath()
        .equalsIgnoreCase("/sbin")
        || file.getAbsolutePath().equalsIgnoreCase("/etc") || file.getAbsolutePath()
        .equalsIgnoreCase("/selinux")
        || file.getAbsolutePath().equalsIgnoreCase("/sys") || file.getAbsolutePath()
        .equalsIgnoreCase("/var")
    ...
    if (file.getAbsolutePath().equalsIgnoreCase("C://") || file.getAbsolutePath()
        .equalsIgnoreCase("C:\\\\")) {
      System.out.println("this is a root directory, you cannot delete all files in it!");
      System.out.println("please change the path!");
      return;
  ...
  private static List<String> listFileName(List<String> fileNamesList, File file, String suffix,
      boolean isDepth) {
  ...
  public static String getFileName(String fileName) {
    ...
    if (shortFileName.contains("/")) {
      shortFileName = shortFileName
          .substring(shortFileName.lastIndexOf("/") + 1, shortFileName.length());
    }

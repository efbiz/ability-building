...
public class HTML2Md {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String s = convertHtml2Content(html, "UTF-8", "#article_content", ".dp-highlighter");
    System.out.println(s);
  }

  public static String convertHtml2Content(String html, String charset, String choiceCss,
      String removeCss) {
  ...
  public static void htmlToJekyllMd(String htmlPath, String mdPath, String charset) {
    try {
      ...
      for (File file : fileList) {
        ...
        String newName =
            dateName + "-" + hmPath.replace(mdPath, "").replace("/", "-") + "-" + file.getName();
